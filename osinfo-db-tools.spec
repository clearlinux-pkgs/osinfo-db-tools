...
Source0  : https://releases.pagure.org/libosinfo/osinfo-db-tools-1.12.0.tar.xz
Source1  : https://releases.pagure.org/libosinfo/osinfo-db-tools-1.12.0.tar.xz.asc
...
%setup -q -n osinfo-db-tools-1.12.0
cd %{_builddir}/osinfo-db-tools-1.12.0
pushd ..
cp -a osinfo-db-tools-1.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730293458
