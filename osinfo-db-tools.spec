...
Source0  : https://releases.pagure.org/libosinfo/osinfo-db-tools-1.10.0.tar.xz
Source1  : https://releases.pagure.org/libosinfo/osinfo-db-tools-1.10.0.tar.xz.asc
...
%prep
%setup -q -n osinfo-db-tools-1.10.0
cd %{_builddir}/osinfo-db-tools-1.10.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645385710
...
cp %{_builddir}/osinfo-db-tools-1.10.0/COPYING %{buildroot}/usr/share/package-licenses/osinfo-db-tools/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
